...
const SKM = () => {
  ...
  const handleBoxClick = (status) => {
    // Navigate to SKMList with status as a URL parameter
    navigate(`/skm-lists?status=${status.toLowerCase()}`);
  };
              ...
              >
                <div className="Heading mt-0">
                  <h4>
                    ...
                    <span> {apiData.total_records}</span>
                  </h4>
                </div>
              </Box>

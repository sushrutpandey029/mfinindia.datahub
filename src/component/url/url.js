...
export const microFinanceActiveEntities = "api/auth/micro-finance-active-entities";
...
export const importMmMasterBorrowingsDataApi = "api/auth/mm-import-master-borrowings-data";

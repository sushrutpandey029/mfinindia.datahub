...
class DisbursementGraph extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      series: [],
      options: {
        ...
        show: true,
        width: [4, 4, 4, 4],
        colors: ["#2B60AD", "#69AB44", "#BD1E22"]
        },
        title: {
          text: 'Disbursement : Quarterly'
        },
        tooltip: {
          y: {
  ...
  componentDidMount() {
    this.getMicrodisbursementGraphData();
  }
  async getMicrodisbursementGraphData() {
    const api = `api/auth/disbursement-disbursement-graph`;
...
export default DisbursementGraph;

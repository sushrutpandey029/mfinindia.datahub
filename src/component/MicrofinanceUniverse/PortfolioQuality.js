...
const DepartmenthandleChange = (event) => {
  ...
  return (
    ...
    >
      <MenuItem value="">
        <em>Overall PAR <ArrowForwardIosIcon style={{ fontSize: "12px"}} /> 0</em>
      </MenuItem>
      <MenuItem value={10}><em>Overall PAR <ArrowForwardIosIcon style={{ fontSize: "12px"}} /> 30</em></MenuItem>
      <MenuItem value={20}><em>Overall PAR <ArrowForwardIosIcon style={{ fontSize: "12px"}} /> 90</em></MenuItem>
      <MenuItem value={20}><em>Overall PAR <ArrowForwardIosIcon style={{ fontSize: "12px"}} /> 180</em></MenuItem>
    </Select>
  </FormControl>
     </Grid>
     <Grid xs={12} sm={12} md={3}>
